...
> Ví dụ 2: Hiển thị các phần tử có trong ArrayList. Để hiển thị các phần tử có trong ArrayList, chúng ta có các cách như sau:
```java
...
```
![image-3](./image/arraylist-trong-java-duyet-cac-phan-tu-2.png)
